...
var MooRainbow = new Class({
	options: {
		id: 'mooRainbow',
		prefix: 'moor-',
		imgPath: '../media/jseblod/moorainbow/images/',
		startColor: [255, 0, 0],
		wheel: false,
	...
	show: function() {
		...
		this.layout.setStyles({'opacity': '100'});
		this.visible = true;
	},
	
	hide: function() {
		this.layout.setStyles({'display': 'block'});
		this.layout.setStyles({'opacity': '0'});
	...
	doLayout: function() {
		...
		var hex = new Element('label').inject(box).setStyle('position', 'absolute').addClass(prefix + 'hexLabel').appendText('Hexa: ').adopt(new Element('input').addClass(prefix + 'hexInput'));
