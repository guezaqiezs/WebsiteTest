...
/*	Property: validate-alpha
	...
	*/
	['validate-alpha', {
		errorMsg: 'Please use letters only (a-zA-Z) in this field.', 
		test: function (element) {
...
/*	Property: validate-alphanum
	...
	*/
	['validate-alphanum', {
		errorMsg: 'Please use only letters (a-zA-Z) or numbers (0-9) only in this field. No spaces or other characters are allowed.', 
		test: function(element) {
	...
	*/
	['validate-alphanum-lower-under', {
		errorMsg: 'Please use letters only (a-z0-9_) in this field.', 
		test: function (element) {
	...
	['validate-date', {
		...
		errorMsg: function(element, props) {
			if (Date.parse) {
				...
				return 'Please enter a valid date such as ' + new Date().format(format);
			} else {
				return 'Please enter a valid date such as MM/DD/YYYY (i.e. "12/31/1999")';
			}
		},
		test: function(element, props) {
...
/*	Property: validate-email
	...
	*/
	['validate-email', {
		errorMsg: 'Please enter a valid email address. For example name@domain.com .', 
		test: function (element) {
