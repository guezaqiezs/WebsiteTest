...
<tr>
    ...
    <?php endif; ?>
    <?php if ( $this->menu_params->get( 'show_action_mode' ) ) : ?>
    <td width="<?php echo $this->menu_params->get( 'action_mode_width' ); ?>" class="sectiontableheader" align="left">
...
<?php for ( $i = 0; $i < $n; $i++ ) {
	...
	$row->link			=	JRoute::_( 'index.php?option=com_cckjseblod&view=type&layout=form&typeid='.$row->id.'&templateid=0&Itemid='.$this->itemId );
?>
<tr class="sectiontableentry<?php echo ( $i % 2 == 0 ) ? 2 : 1;?>">
    ...
    <?php endif; ?>
    <?php if ( $this->menu_params->get( 'show_action_mode' ) ) : ?>
    <td width="<?php echo $this->menu_params->get( 'action_mode_width' ); ?>" align="left">
        <?php echo $row->action_mode; ?>
    </td>
    <?php endif; ?>
    <?php if ( $this->menu_params->get( 'show_state' ) ) : ?>
