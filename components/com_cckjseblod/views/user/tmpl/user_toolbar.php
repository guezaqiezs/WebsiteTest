...
<?php if ( $this->menu_params->get( 'enable_add' ) == 'left' ) : ?>
    <button style="float: <?php echo $this->menu_params->get( 'enable_add', 'left' ) ?>;" class="common_submit" type="submit" name="task" value="user_add">
        <?php echo JText::_( 'NEW' ); ?>
    </button>
<?php endif; ?>
<?php if ( $this->menu_params->get( 'enable_publish' ) == 'left' ) : ?>
	<button style="float: <?php echo $this->menu_params->get( 'enable_publish', 'left' ) ?>;" class="common_submit" type="submit" name="task" value="user_publish">
		<?php echo JText::_( 'PUBLISH' ); ?>
	</button>
<?php endif; ?>
<?php if ( $this->menu_params->get( 'enable_unpublish' ) == 'left' ) : ?>
	<button style="float: <?php echo $this->menu_params->get( 'enable_unpublish', 'left' ) ?>;" class="common_submit" type="submit" name="task" value="user_unpublish">
		<?php echo JText::_( 'UNPUBLISH' ); ?>
	</button>
<?php endif; ?>
<?php if ( $this->menu_params->get( 'enable_delete' ) == 'left' ) : ?>
    <button style="float: <?php echo $this->menu_params->get( 'enable_delete', 'left' ) ?>;" class="common_submit" type="submit" name="task" value="user_trash">
