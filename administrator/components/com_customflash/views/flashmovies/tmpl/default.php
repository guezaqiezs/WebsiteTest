...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th class="title">
				<?php echo JHTML::_('grid.sort',   JText::_( 'MOVIE NAME' ), 'moviename', @$this->lists['order_Dir'], @$this->lists['order'] ); ?>
			</th>
	...
	foreach ($rows as $row)
	{
		...
		$link_edittable='index.php?option=com_customflash&controller=flashmovies&task=edit&cid[]='.$row->id;
		...
		<tr class="<?php echo "row$k"; ?>">
			...
			<td nowrap="nowrap">
				<?php echo '<a href="'.$link_edittable.'">'.$row->moviename.'</a>'; ?>
			</td>
			<td nowrap="nowrap">
				<?php echo $row->file; ?>
			</td>
