...
/**
 * Types_Categories		Table Class
 **/
class TableTypes_Categories extends JTable
{
	/**
	 * Vars
	 **/
	 ...
	 * Constructor
	 **/
	function TableTypes_Categories( & $db ) {
		parent::__construct( '#__jseblod_cck_types_categories', 'id', $db );
	}
