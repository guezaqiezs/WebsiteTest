...
/**
 * Searchs_Categories		Table Class
 **/
class TableSearchs_Categories extends JTable
{
	/**
	 * Vars
	 **/
	 ...
	 * Constructor
	 **/
	function TableSearchs_Categories( & $db ) {
		parent::__construct( '#__jseblod_cck_searchs_categories', 'id', $db );
	}
