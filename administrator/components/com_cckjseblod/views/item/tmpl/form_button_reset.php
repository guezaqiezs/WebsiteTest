...
<legend class="legend-border">
	<span class="editlinktip hasTip2" title="<?php echo JText::_( 'BUTTON RESET' ); ?>::<?php echo JText::_( 'DESCRIPTION BUTTON RESET' ); ?>">
		<?php echo JText::_( 'BUTTON RESET' ); ?>
    </span>
</legend>
	<table class="admintable">
		...
		<tr>
			...
			<td>
				<input class="inputbox required required-enabled" type="text" id="label" name="label" maxlength="50" size="32" value="<?php echo ( @$this->item->label ) ? $this->item->label : 'Reset'; ?>" />
			</td>
		</tr>
        <?php } ?>
    </table>
...
<input type="hidden" name="type" value="button_reset" />
<?php } ?>