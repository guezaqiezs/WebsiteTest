...
<legend class="legend-border">
  	<span class="editlinktip hasTip2" title="<?php echo JText::_( 'SELECT MULTIPLE' ); ?>::<?php echo JText::_( 'DESCRIPTION SELECT MULTIPLE' ); ?>">
		<?php echo JText::_( 'SELECT MULTIPLE' ); ?>
    </span>
</legend>
	...
	<table class="admintable">		<tr>
		...
		<tr>
			<td width="25" align="right" class="key_jseblod">
				<span class="editlinktip hasTip2" title="<?php echo JText::_( 'DEFAULT VALUE' ); ?>::<?php echo JText::_( 'DEFAULT VALUE BALLOON' ); ?>">
					<?php echo _IMG_BALLOON_LEFT; ?>
				</span>
			</td>
			<td width="100" align="right" class="key">
	...
	<table class="admintable">
		<tr>
			...
			<td>
				<input class="inputbox" type="text" id="rows" name="rows" maxlength="50" size="16" value="<?php echo ( @$this->item->rows ) ? $this->item->rows : 0; ?>" />
			</td>
		</tr>
	</table>
    <table class="admintable header_jseblod" >
...
<input type="hidden" name="type" value="select_multiple" />
<?php } ?>