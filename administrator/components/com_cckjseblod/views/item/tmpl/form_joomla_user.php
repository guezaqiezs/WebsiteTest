...
<legend class="legend-border">
	<span class="editlinktip hasTip2" title="<?php echo JText::_( 'JOOMLA USER' ); ?>::<?php echo JText::_( 'DESCRIPTION JOOMLA USER' ); ?>">
		<?php echo JText::_( 'JOOMLA USER' ); ?>
    </span>
</legend>
...
<input type="hidden" name="type" value="joomla_user" />
<?php } ?>