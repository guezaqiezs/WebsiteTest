...
<legend class="legend-border">
	<span class="editlinktip hasTip2" title="<?php echo JText::_( 'SUB PANEL TAB' ); ?>::<?php echo JText::_( 'DESCRIPTION SUB PANEL TAB' ); ?>">
		<?php echo JText::_( 'SUB PANEL TAB' ); ?>
    </span>
</legend>
		...
		<tr id="as-force-1" class="<?php echo ( @$this->item->bool2 ) ? '' : 'display-no' ?>" >
			...
			<td width="100" align="right" class="key">
				<span class="editlinktip hasTip2" title="<?php echo JText::_( 'CLOSER MODE'); ?>::<?php echo JText::_( 'CHOOSE CLOSER MODE OR NOT' ); ?>">
					<?php echo JText::_( 'CLOSER MODE').' 3'; ?>:
				</span>
			</td>
			<td>
	...
	<table class="admintable">
		<tr>
			<td colspan="3">
				<?php echo JText::_( 'SUBPANEL EXPLANATION' ); ?>
			</td>
		</tr>
    </table>
</fieldset>
...
<input type="hidden" name="type" value="sub_panel_tab" />
<?php } ?>