...
<div>
	...
	<div class="header icon-48-types" style="float: left">
		<?php echo JText::_( 'CONTENT TYPE' ) . ': <small><small>[ '.JText::_( 'CONFIGURE ADMIN' ).' ]</small></small>'; ?>
	</div>
	...
	<legend class="legend-border"><?php echo JText::_( 'ADMIN FORM ITEMS' ); ?></legend>
		<?php
        $tab_state_cookie_name = 'cck_content_type_admin';
        ...
        echo $pane->startPanel( JText::_( 'CONFIGURE ADMIN COMMON' ), 'panel1' );
        ?>
        ...
        <?php
        echo $pane->endPanel();
        echo $pane->startPanel( JText::_( 'CONFIGURE ADMIN ADVANCED' ), 'panel2' );
        ?>
		<table class="admintable">
            <tr>
                <td width="5" align="center" class="key_jseblod">
		...
		<table class="admintable">
			<tr>
				<td>
                    ...
                    <?php echo '&nbsp;&nbsp;> ' . JText::_( 'LIVE TYPE ADMIN DESCRIPTION' ); ?>
			...
			if ( sizeof( $this->typeItems ) ) {
				...
				foreach ( $this->typeItems as $item ) {
					if ( $item->typename == 'content_type' ) {
						...
						$selectACL	=	( @$this->typeItemValues[$item->name.'_acl'] != '' ) ? explode( ',', $this->typeItemValues[$item->name.'_acl'] ) : array( '23', '24', '25' );
