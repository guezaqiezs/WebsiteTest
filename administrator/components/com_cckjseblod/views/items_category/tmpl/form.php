...
$javascript ='
	...
	var url="index.php?option=com_cckjseblod&controller=items_categories&task=checkAvailability&format=raw&available="+available;
		var a=new Ajax(url,{
			method:"get",
			update:"",
...
<div class="col width-50">
	...
	<legend class="legend-border"><?php echo JText::_( 'Details' ); ?></legend>
		<table class="admintable">
			...
			<?php if ( ! ( $this->category->id == 1 || $this->category->id == 2 || $this->category->id == 3 ) ) { ?>
			<tr>
                <td width="25" align="right" class="key_jseblod">
				</td>
				<td width="100" align="right" class="key" colspan="2">
			...
			<tr>
				<td width="25" align="right" class="key_jseblod">
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'DISPLAY ITEMS' ); ?>::<?php echo JText::_( 'DISPLAY ITEMS BALLOON' ); ?>">
						<?php echo _IMG_BALLOON_LEFT; ?>
					</span>
				</td>
				<td width="100" align="right" class="key" colspan="2">
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'DISPLAY ITEMS' ); ?>::<?php echo JText::_( 'DISPLAY ITEMS LABEL' ); ?>">
						<?php echo JText::_( 'DISPLAY ITEMS' ); ?>:
					</span>
				</td>
				<td>
