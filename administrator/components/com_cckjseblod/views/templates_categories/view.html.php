...
/**
 * Templates_Categories		View Class
 **/
class CCKjSeblodViewTemplates_Categories extends JView
{
	/**
	 * Display Toolbar
	 **/
	...
	{
		JToolBarHelper::title(   JText::_( 'TEMPLATE CATEGORY MANAGER' ), 'category.png' );
		...
		if ( $isAuth ) {
			...
			switch( _TEMPLATE_CATEGORY_DELETE_MODE ) {
				case '1':
	...
	function display( $tpl = null )
	{
		...
		// Set Search Filter
		$optSearch[] 		=	JHTML::_( 'select.option', '<OPTGROUP>', JText::_( 'TEMPLATE CATEGORIES' ) );
		...
		$optCategories		=	array_merge( $optCategories, HelperjSeblod_Helper::getTemplateCategories( false, false ) );
