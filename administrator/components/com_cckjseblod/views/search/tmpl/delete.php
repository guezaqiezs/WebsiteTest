	...
	<table class="adminForm">
		<tr>
			...
			<td valign="top" width="20%">
				...
				<font color="#000066"><strong><?php echo count( $this->searchRemoveItems ); ?></strong></font><br /><br />
			</td>
			<td valign="top" width="25%">
				<strong><?php echo JText::_( 'Items being Deleted' ); ?>:</strong><br />
				<?php echo "<ol>";
				    if ( sizeof( $this->searchRemoveItems ) ) {
  					  foreach ( $this->searchRemoveItems as $item ) {
			...
			<td valign="top" width="25%">
				<strong><?php echo JText::_( 'DELETE SEARCH WITHOUT' ); ?></strong><br /><br /><br />
			...
			<td valign="top" width="25%">
				<strong><?php echo JText::_( 'DELETE SEARCH WITH' ); ?></strong><br /><br /><br />
