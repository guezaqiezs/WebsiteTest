...
/**
 * Items_Categories	View Class
 **/
class CCKjSeblodViewItems_Categories extends JView
{
	/**
	 * Display Toolbar
	 **/
	...
	{
		JToolBarHelper::title(   JText::_( 'FIELD CATEGORY MANAGER' ), 'category.png' );
		...
		if ( $isAuth ) {
			...
			switch( _ITEM_CATEGORY_DELETE_MODE ) {
				case '1':
	...
	function display( $tpl = null )
	{
		...
		// Set Search Filter
		$optSearch[] 		=	JHTML::_( 'select.option', '<OPTGROUP>', JText::_( 'ITEM CATEGORIES' ) );
		...
		$optCategories		=	array_merge( $optCategories, HelperjSeblod_Helper::getItemCategories( false, false ) );
