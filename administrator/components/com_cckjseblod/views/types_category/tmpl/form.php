...
$javascript ='
	...
	var url="index.php?option=com_cckjseblod&controller=types_categories&task=checkAvailability&format=raw&available="+available;
		var a=new Ajax(url,{
			method:"get",
			update:"",
...
<div class="col width-50">
	...
	<legend class="legend-border"><?php echo JText::_( 'Details' ); ?></legend>
		<table class="admintable">
			...
			<tr>
				<td width="25" align="right" class="key_jseblod">
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'DISPLAY TYPES' ); ?>::<?php echo JText::_( 'DISPLAY TYPES BALLOON' ); ?>">
						<?php echo _IMG_BALLOON_LEFT; ?>
					</span>
				</td>
				<td width="100" align="right" class="key" colspan="2">
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'DISPLAY TYPES' ); ?>::<?php echo JText::_( 'DISPLAY TYPES LABEL' ); ?>">
						<?php echo JText::_( 'DISPLAY TYPES' ); ?>:
					</span>
				</td>
				<td>
