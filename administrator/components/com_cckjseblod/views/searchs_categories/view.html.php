...
/**
 * Searchs_Categories		View Class
 **/
class CCKjSeblodViewSearchs_Categories extends JView
{
	/**
	 * Display Toolbar
	 **/
	...
	{
		JToolBarHelper::title(   JText::_( 'SEARCH TYPE CATEGORY MANAGER' ), 'category.png' );
		...
		if ( $isAuth ) {
			...
			switch( _SEARCH_CATEGORY_DELETE_MODE ) {
				case '1':
	...
	function display( $tpl = null )
	{
		...
		// Set Search Filter
		$optSearch[] 		=	JHTML::_( 'select.option', '<OPTGROUP>', JText::_( 'SEARCH CATEGORIES' ) );
		...
		$optCategories		=	array_merge( $optCategories, HelperjSeblod_Helper::getSearchCategories( false, false ) );
