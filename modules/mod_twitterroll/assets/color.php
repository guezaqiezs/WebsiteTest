...
class JElementColor extends JElement {
	...
	function fetchElement($name, $value, &$node, $control_name) {
		ob_start();
		$img=JUri::root()."modules/mod_twitterroll/images/rainbow.png";
		$imgx=JUri::root()."modules/mod_twitterroll/images/";
		static $embedded;
		if(!$embedded) {
			$css2=JUri::root()."modules/mod_twitterroll/css/mooRainbow.css";
			$jspath=JUri::root()."modules/mod_twitterroll/js/mooRainbow.js";
?>
